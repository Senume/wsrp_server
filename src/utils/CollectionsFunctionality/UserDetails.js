...
class UsersDetails {
    ...
    async FindUser(UserName){
        try {
            ...
            const Cursor = Collection.find({'UserName': {$eq: UserName}}, { projection: { _id: 0 } });
    ...
    async UpdateUser(Data) {
        try {
            ...
            const Result = await Collection.updateOne({'UserName': {$eq: Data.UserName}}, {$set: Data}, {upsert: true});
            ...
            throw new Error("Document modifying/adding operation failed");
        }
    }
}
